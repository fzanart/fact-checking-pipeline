...
class Debunker:
    ...
    def generate_rd_layer(self, claim):
        ...
        incontext_prompt = [
            ...
            for message in INCONTEXT
        ]

        content = self.llm.invoke(incontext_prompt).content
